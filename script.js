...
var timer = document.querySelector("#timer_value")
...
saveButton.addEventListener("click", function(){
    var listItem = document.querySelector("timer")
    var userAssignment = []
    listItem.forEach(function(timer){
        userAssignment.push(timer.innerHTML);
    });
